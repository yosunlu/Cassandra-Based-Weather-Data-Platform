...
# SPARK
RUN wget https://dlcdn.apache.org/spark/spark-3.4.3/spark-3.4.3-bin-hadoop3.tgz && tar -xf spark-3.4.3-bin-hadoop3.tgz && rm spark-3.4.3-bin-hadoop3.tgz
...
ENV PATH="${PATH}:/apache-cassandra-4.1.3/bin:/spark-3.4.3-bin-hadoop3.2/bin"
